...
mkdir(fname);
backupcode('RUN_efast_ode3v2strain', fname);
...
theta_yA      = [Vmax_gluc_yA Km_gluc_yA eta_yA Vmax_yA_B Km_yA_B Vmax_yA_C Km_yA_C delta_yA_A];
theta_yB      = [Vmax_gluc_yB Km_gluc_yB eta_yB Vmax_yB_A Km_yB_A Vmax_yB_C Km_yB_C delta_yB_B];
theta_yC      = [Vmax_gluc_yC Km_gluc_yC eta_yC Vmax_yC_A Km_yC_A Vmax_yC_B Km_yC_B delta_yC_C];
...
kmidpoint(13:20) = theta_yA;
kmidpoint(21:28) = theta_yB;
kmidpoint(29:36) = theta_yC;
kmidpoint(37:39) = omega;
...
klistnames{18} = 'Vmax_yA_C';    kc0(18) = 0; klb(18) = 1;    kub(18) = 120;   klist(18,:) = [1];
klistnames{19} = 'Km_yA_C';      kc0(19) = 0; klb(19) = 1;    kub(19) = 1000;  klist(19,:) = [0];
klistnames{20} = 'delta_yA_A';   kc0(20) = 0; klb(20) = 1e-2; kub(20) = 1;     klist(20,:) = [0];
% --- Strain B ------------------------------------------------------------
klistnames{21} = 'Vmax_gluc_yB'; kc0(21) = 0; klb(21) = 1;    kub(21) = 30;    klist(21,:) = [1];
klistnames{22} = 'Km_gluc_yB';   kc0(22) = 0; klb(22) = 1;    kub(22) = 100;   klist(22,:) = [0];
klistnames{23} = 'eta_yB';       kc0(23) = 0; klb(23) = 1e-4; kub(23) = 1e-2;  klist(23,:) = [0];
klistnames{24} = 'Vmax_yB_A';    kc0(24) = 0; klb(24) = 1;    kub(24) = 120;   klist(24,:) = [1];
klistnames{25} = 'Km_yB_A';      kc0(25) = 0; klb(25) = 1;    kub(25) = 1000;  klist(25,:) = [0];
klistnames{26} = 'Vmax_yB_C';    kc0(26) = 0; klb(26) = 1;    kub(26) = 120;   klist(26,:) = [1];
klistnames{27} = 'Km_yB_C';      kc0(27) = 0; klb(27) = 1;    kub(27) = 1000;  klist(27,:) = [0];
klistnames{28} = 'delta_yB_B';   kc0(28) = 0; klb(28) = 1e-2; kub(28) = 1;     klist(28,:) = [0];
% --- Strain B ------------------------------------------------------------
klistnames{29} = 'Vmax_gluc_yC'; kc0(29) = 0; klb(29) = 1;    kub(29) = 30;    klist(29,:) = [1];
klistnames{30} = 'Km_gluc_yC';   kc0(30) = 0; klb(30) = 1;    kub(30) = 100;   klist(30,:) = [0];
klistnames{31} = 'eta_yC';       kc0(31) = 0; klb(31) = 1e-4; kub(31) = 1e-2;  klist(31,:) = [0];
klistnames{32} = 'Vmax_yC_A';    kc0(32) = 0; klb(32) = 1;    kub(32) = 120;   klist(32,:) = [1];
klistnames{33} = 'Km_yC_A';      kc0(33) = 0; klb(33) = 1;    kub(33) = 1000;  klist(33,:) = [0];
klistnames{34} = 'Vmax_yC_B';    kc0(34) = 0; klb(34) = 1;    kub(24) = 120;   klist(34,:) = [1];
klistnames{35} = 'Km_yC_B';      kc0(35) = 0; klb(35) = 1;    kub(35) = 1000;  klist(35,:) = [0];
klistnames{36} = 'delta_yC_C';   kc0(36) = 0; klb(36) = 1e-2; kub(36) = 1;     klist(36,:) = [0];
% --- Leaks ---------------------------------------------------------------
klistnames{37} = 'phi_yA_A';     kc0(37) = 0; klb(37) = 1e-2; kub(37) = 0.5;   klist(37,:) = [1];
klistnames{38} = 'phi_yB_B';     kc0(38) = 0; klb(38) = 1e-2; kub(38) = 0.5;   klist(38,:) = [1];
klistnames{39} = 'phi_yC_C';     kc0(39) = 0; klb(39) = 1e-2; kub(39) = 0.5;   klist(39,:) = [1];
...
% --- Build function ------------------------------------------------------
odefun = @(X) efast3v2strainsV2b(X, kmidpoint, kidx, tmax, odeoptions);
