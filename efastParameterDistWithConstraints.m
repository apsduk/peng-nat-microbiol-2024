...
function Xdist = efastParameterDistWithConstraints(X,pmax,pmin,pmean,pstd,nsample,type, constrainedkidx)
...
% ----- Constrain the values of constrained kidx --------------------------
for i = 1:length(Xdist(:,1))
    Xdist(i,constrainedkidx) = Xdist(i,constrainedkidx)./sum(Xdist(i,constrainedkidx));
end
