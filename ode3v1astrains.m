function [dZ_by_dt, J0_grow, J0_upt_gluc, J0_leak_Y, J0_upt_Y] = ode3v1astrains(T, Z, theta_biomass, theta_yA, theta_yB, theta_yC, omega)
...
% ----- Strain A parameters (A+/B-) ---------------------------------------
% ----- (e.g. lys production, ade uptake) ---------------------------------
...
dC_by_dt = J_leak_yC_C*yCa - J_upt_yB_C*yBa;
...
J0_upt_Y     = [J_upt_yC_A*yCa    , J_upt_yA_B*yAa    , J_upt_yB_C*yBa];
