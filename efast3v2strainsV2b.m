function [performancevector, performancenames, T, yNa, Y] = efast3v2strains(X, kvector, kidx, tmax, odeoptions)
...
theta_yA      = kvector(13:20);
theta_yB      = kvector(21:28);
theta_yC      = kvector(29:36);
omega         = kvector(37:39);
...
%% ===== SIMULATE MODEL ===================================================
[T, Y] = ode15s( @(T, Z) ode3v2strains(T, Z, theta_biomass, theta_yA, theta_yB, theta_yC, omega), [0, tmax], Y0, odeoptions);
...
for t = 1:length(T)
    [dY_by_dt(t,:), J0_grow(t,:), J0_upt_gluc(t,:), J0_leak_yX_X(t,:), J0_upt_yX_Y(t,:)] = ode3v2strains(T(t), Y(t,:), theta_biomass, theta_yA, theta_yB, theta_yC, omega);
end
