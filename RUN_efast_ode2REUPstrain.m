...
% --- Back code up --------------------------------------------------------
fname = 'EFAST_ode2REUPstrain';
mkdir(fname);
backupcode('RUN_efast_ode2REUPstrain', fname);
...
Vmax_yA_A    = 30;   % Maximum A uptake rate by strain A
...
Vmax_yB_A    = 30;   % Maximum A uptake rate by strain B
Km_yB_A      = 50;   % Michaelis constant for A uptake
Vmax_yB_B    = 30;   % Maximum B uptake rate by strain B
...
theta_yA      = [Vmax_gluc_yA Km_gluc_yA eta_yA Vmax_yA_A Km_yA_A Vmax_yA_B Km_yA_B delta_yA_A ];
theta_yB      = [Vmax_gluc_yB Km_gluc_yB eta_yB Vmax_yB_A Km_yB_A Vmax_yB_B Km_yB_B delta_yB_B];
...
klistnames{13} = 'Vmax_yA_A';    kc0(13) = 0; klb(13) = 1;    kub(13) = 120;   klist(13,:) = [1];
klistnames{14} = 'Km_yA_A';      kc0(14) = 0; klb(14) = 1;    kub(14) = 1000;  klist(14,:) = [0];
klistnames{15} = 'Vmax_yA_B';    kc0(15) = 0; klb(15) = 1;    kub(15) = 120;   klist(15,:) = [1];
klistnames{16} = 'Km_yA_B';      kc0(16) = 0; klb(16) = 1;    kub(16) = 1000;  klist(16,:) = [0];
klistnames{17} = 'delta_yA_A';   kc0(17) = 0; klb(17) = 1e-2; kub(17) = 1;     klist(17,:) = [0];
% --- Strain B ------------------------------------------------------------
...
klistnames{23} = 'Vmax_yB_B';    kc0(23) = 0; klb(23) = 1;    kub(23) = 120;   klist(23,:) = [1];
klistnames{24} = 'Km_yB_B';      kc0(24) = 0; klb(24) = 1;    kub(24) = 1000;  klist(24,:) = [0];
...
% --- Build function ------------------------------------------------------
odefun = @(X) efast2REUPstrainsV2b(X, kmidpoint, kidx, tmax, odeoptions);
