...
% --- Back code up --------------------------------------------------------
fname = 'EFAST_ode3v1bstrain';
mkdir(fname);
backupcode('RUN_efast_ode3v1bstrain', fname);
...
delta_yA_C   = 0;   % Number of C molecules produced per molecule of glucose is consumed, assume no burden?
...
theta_yA      = [Vmax_gluc_yA Km_gluc_yA eta_yA Vmax_yA_B Km_yA_B delta_yA_A delta_yA_C];
...
omega         = [phi_yA_A phi_yA_C phi_yB_B phi_yC_C];
...
kmidpoint(13:19) = theta_yA;
kmidpoint(20:25) = theta_yB;
kmidpoint(26:31) = theta_yC;
kmidpoint(32:35) = omega;
...
klistnames{19} = 'delta_yA_C';   kc0(19) = 0; klb(19) = 1e-2; kub(19) = 1;    klist(19,:) = [0];
% --- Strain B ------------------------------------------------------------
klistnames{20} = 'Vmax_gluc_yB'; kc0(20) = 0; klb(20) = 1;    kub(20) = 30;   klist(20,:) = [1];
klistnames{21} = 'Km_gluc_yB';   kc0(21) = 0; klb(21) = 1;    kub(21) = 100;  klist(21,:) = [0];
klistnames{22} = 'eta_yB';       kc0(22) = 0; klb(22) = 1e-4; kub(22) = 1e-2; klist(22,:) = [0];
klistnames{23} = 'Vmax_yB_C';    kc0(23) = 0; klb(23) = 1;    kub(23) = 120;  klist(23,:) = [1];
klistnames{24} = 'Km_yB_C';      kc0(24) = 0; klb(24) = 1;    kub(24) = 1000; klist(24,:) = [0];
klistnames{25} = 'delta_yB_B';   kc0(25) = 0; klb(25) = 1e-2; kub(25) = 1;    klist(25,:) = [0];
% --- Strain B ------------------------------------------------------------
klistnames{26} = 'Vmax_gluc_yC'; kc0(26) = 0; klb(26) = 1;    kub(26) = 30;   klist(26,:) = [1];
klistnames{27} = 'Km_gluc_yC';   kc0(27) = 0; klb(27) = 1;    kub(27) = 100;  klist(27,:) = [0];
klistnames{28} = 'eta_yC';       kc0(28) = 0; klb(28) = 1e-4; kub(28) = 1e-2; klist(28,:) = [0];
klistnames{29} = 'Vmax_yC_A';    kc0(29) = 0; klb(29) = 1;    kub(29) = 120;  klist(29,:) = [1];
klistnames{30} = 'Km_yC_A';      kc0(30) = 0; klb(30) = 1;    kub(30) = 1000; klist(30,:) = [0];
klistnames{31} = 'delta_yC_C';   kc0(31) = 0; klb(31) = 1e-2; kub(31) = 1;    klist(31,:) = [0];
% --- Leaks ---------------------------------------------------------------
klistnames{32} = 'phi_yA_A';     kc0(32) = 0; klb(32) = 1e-2; kub(32) = 0.5;  klist(32,:) = [1];
klistnames{33} = 'phi_yA_C';     kc0(33) = 0; klb(33) = 1e-2; kub(33) = 0.5;  klist(33,:) = [1];
klistnames{34} = 'phi_yB_B';     kc0(34) = 0; klb(34) = 1e-2; kub(34) = 0.5;  klist(34,:) = [1];
klistnames{35} = 'phi_yC_C';     kc0(35) = 0; klb(35) = 1e-2; kub(35) = 0.5;  klist(35,:) = [1];
...
% --- Build function ------------------------------------------------------
odefun = @(X) efast3v1bstrainsV2b(X, kmidpoint, kidx, tmax, odeoptions);
