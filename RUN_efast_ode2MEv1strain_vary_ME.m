...
mkdir(fname);
backupcode('RUN_efast_ode2MEv1strain_vary_ME', fname);
...
klistnames{25} = 'phi_yA_X';     kc0(25) = 0; klb(25) = 1e-2; kub(25) = 0.5;   klist(25,:) = [1];
klistnames{26} = 'Vmax_yB_XY';   kc0(26) = 0; klb(26) = 1;    kub(26) = 120;   klist(26,:) = [1];
